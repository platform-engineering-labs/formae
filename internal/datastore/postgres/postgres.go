...
// accounting for exclusion and wildcard `*` prefix/suffix on strings.
func pgOpAndOperand(v any, isExcluded bool) (op string, operand any, isLike bool) {
	...
	return likeOp, pgLikePattern(s, prefix, suffix), true
}
...
func pgLikePattern(s string, prefix, suffix bool) string {
	inner := s
	if prefix {
