...
--
-- KSUID-shaped columns (command_id, version, id, ksuid) are declared with
-- COLLATE Latin1_General_BIN2 so equality and ordering are byte-exact.
-- MSSQL's default collation is case-insensitive, which would treat KSUIDs
-- like 'abc' and 'ABC' as equal — corrupting PK uniqueness and the
-- "latest version" NOT EXISTS subqueries used across this backend.
...
CREATE TABLE resources (
    ...
    ksuid      nvarchar(450) COLLATE Latin1_General_BIN2,
...
CREATE TABLE resource_updates (
    command_id            nvarchar(450) COLLATE Latin1_General_BIN2 NOT NULL,
    ksuid                 nvarchar(450) COLLATE Latin1_General_BIN2 NOT NULL,
...
CREATE TABLE policies (
    ...
    stack_id    nvarchar(450) COLLATE Latin1_General_BIN2,  -- NULL/empty = standalone, set = inline to that stack
...
CREATE TABLE stack_policies (
    ...
    policy_id  nvarchar(450) COLLATE Latin1_General_BIN2 NOT NULL,
