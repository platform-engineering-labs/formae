...
ALTER TABLE resource_updates ADD provenance_records nvarchar(max) NULL, resolved_root_digests nvarchar(max) NULL;

-- +goose Down
ALTER TABLE resource_updates DROP COLUMN provenance_records, resolved_root_digests;
