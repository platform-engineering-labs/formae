module github.com/platform-engineering-labs/formae/tests/e2e/go/fixtures/oidc-echo-plugin
...
// Match the SDK (pkg/plugin) and the agent: a plugin must run the forked
...
require (
	ergo.services/actor/statemachine v0.0.0-00010101000000-000000000000 // indirect
